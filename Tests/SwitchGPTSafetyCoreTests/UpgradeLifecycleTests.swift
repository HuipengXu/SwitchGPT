...
final class UpgradeLifecycleTests: XCTestCase {
  func testStableFingerprintSurvivesAuthRefreshWithoutPersistingSourceFields() throws {
    ...
    let storedData = try Data(contentsOf: store.directoryURL.appendingPathComponent("account.fingerprint"))
  ...
  func testUpgradeRunsOldUnregisterThenSeparateInstallThenCandidateRegister() throws {
    ...
    XCTAssertTrue(fixture.platform.installedArtifactIDs.contains(fixture.candidateBundle.artifactID))
  ...
  func testRecoveryOnlyFinalizesCandidateAlreadyRegisteredBeforeCrash() throws {
    ...
    XCTAssertEqual(
      ...
      ["read", "verify:\(fixture.oldBundle.artifactID)", "verify:\(fixture.candidateBundle.artifactID)"]
    )
